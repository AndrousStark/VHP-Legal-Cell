...
const MOCK_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    body: "All Chetra and Prant Convenors are required to submit their quarterly activity and case reports by March 15, 2026. Reports should include case updates, activity summaries, and financial statements. Please use the standard template available in the Resources section.",
    date: "2026-02-24",
  ...
  },
  {
    ...
    body: "The annual VHP Legal Cell National Convention will be held at India International Centre, New Delhi from April 5-7, 2026. All National and Chetra level members must attend. Registration is now open through the dashboard.",
    date: "2026-02-20",
